...
exports.handlers = new Map([
    ...
    [
        ...
        async function (runState) {
            const addressBigInt = runState.stack.pop();
            const size = BigInt(
                (await runState.eei.getContractCode(new util_1.Address((0, util_2.addressToBuffer)(addressBigInt))))
                    .length
            );
    ...
    [
        ...
        async function (runState) {
            ...
            const codeHash = (
                await runState.eei.getAccount(new util_1.Address((0, util_2.addressToBuffer)(addressBigInt)))
            ).codeHash;
    ...
    [
        ...
        function (runState, common) {
            ...
            const loaded = (0, util_1.bufferToBigInt)(
                runState.interpreter.getCode().slice(runState.programCounter, runState.programCounter + numToPush)
            );
    ...
    [
        ...
        function (runState) {
            ...
            if (length !== BigInt(0)) {
                ...
                console.log("return data -->", returnData.toString("utf-8"));
            }
